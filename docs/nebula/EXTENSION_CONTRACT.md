...
No `packages/nebula-*` package or parallel runtime was created. Ownership enforcement is implemented over the stable Task/workspace identity and inherited Git executor. Agent ownership requests, shared-resource locking, Missions, and routing remain not implemented.
