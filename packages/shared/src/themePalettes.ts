export const BUILT_IN_THEME_IDS = ["nebula", "t3-chat", "grove", "ocean", "ember", "iris"] as const;
...
/** Nebula's product palette. The stable id is additive so existing T3 theme
 * preferences and custom-theme storage remain readable across the fork. */
export const NEBULA_THEME: ThemeDefinition = {
  id: "nebula",
  label: "Nebula",
  appearance: "dark",
  colors: {
    canvas: "oklch(0.172605 0.054134 258.295)",
    chrome: "oklch(0.19039 0.043748 255.912)",
    toolbar: "oklch(0.199944 0.044926 257.333)",
    toolbarForeground: "oklch(0.9795 0.005415 274.967)",
    toolbarBorder: "oklch(0.314924 0.048312 258.283)",
    toolbarControl: "oklch(0.244018 0.052726 259.007)",
    toolbarControlForeground: "oklch(0.9795 0.005415 274.967)",
    toolbarControlHover: "oklch(0.283619 0.058032 257.048)",
    surface: "oklch(0.207746 0.042783 256.489)",
    surfaceRaised: "oklch(0.244018 0.052726 259.007)",
    surfaceOverlay: "oklch(0.262897 0.050753 257.161)",
    text: "oklch(0.9795 0.005415 274.967)",
    textMuted: "oklch(0.760787 0.025516 259.82)",
    border: "oklch(0.314924 0.048312 258.283)",
    input: "oklch(0.315627 0.047763 259.537)",
    focus: "oklch(0.729882 0.167895 32.969)",
    accent: "oklch(0.699027 0.193035 32.105)",
    accentForeground: "oklch(0.172605 0.054134 258.295)",
    secondary: "oklch(0.262897 0.050753 257.161)",
    secondaryForeground: "oklch(0.9795 0.005415 274.967)",
    muted: "oklch(0.244018 0.052726 259.007)",
    mutedForeground: "oklch(0.760787 0.025516 259.82)",
    placeholder: "oklch(0.639782 0.036866 259.397)",
    secondaryLabel: "oklch(0.760787 0.025516 259.82)",
    iconMuted: "oklch(0.760787 0.025516 259.82)",
    error: "oklch(0.694948 0.196449 18.498)",
    errorForeground: "oklch(0.8284 0.09668 13.77)",
    errorSurface: "oklch(0.24148 0.047915 3.78)",
    warning: "oklch(0.816503 0.139859 80.096)",
    warningForeground: "oklch(0.901502 0.100438 83.072)",
    warningSurface: "oklch(0.277709 0.043275 81.634)",
    update: "oklch(0.79115 0.157831 65.059)",
    updateForeground: "oklch(0.880303 0.134778 86.062)",
    updateSurface: "oklch(0.277709 0.043275 81.634)",
    accentSurface: "oklch(0.249 0.030362 331.457)",
    accentSurfaceForeground: "oklch(0.9795 0.005415 274.967)",
    messageSurface: "oklch(0.244018 0.052726 259.007)",
    messageForeground: "oklch(0.9795 0.005415 274.967)",
    messageAction: "oklch(0.699027 0.193035 32.105)",
    messageActionForeground: "oklch(0.172605 0.054134 258.295)",
    messageActionHover: "oklch(0.729882 0.167895 32.969)",
    codeBackground: "oklch(0.19039 0.043748 255.912)",
    codeForeground: "oklch(0.9795 0.005415 274.967)",
    sidebar: "oklch(0.19039 0.043748 255.912)",
    sidebarForeground: "oklch(0.9795 0.005415 274.967)",
    sidebarMutedForeground: "oklch(0.760787 0.025516 259.82)",
    sidebarControlSurface: "oklch(0.244018 0.052726 259.007)",
    sidebarRowHover: "oklch(0.244018 0.052726 259.007)",
    sidebarRowActive: "oklch(0.283619 0.058032 257.048)",
    sidebarRowSelected: "oklch(0.249 0.030362 331.457)",
    sidebarBorder: "oklch(0.314924 0.048312 258.283)",
    terminalBackground: "oklch(0.172605 0.054134 258.295)",
    terminalForeground: "oklch(0.9795 0.005415 274.967)",
    terminalCursor: "oklch(0.699027 0.193035 32.105)",
    terminalSelection: "oklch(0.314924 0.048312 258.283)",
    terminalScrollbar: "oklch(0.315627 0.047763 259.537)",
    terminalScrollbarHover: "oklch(0.639782 0.036866 259.397)",
  },
  variants: {
    light: {
      canvas: "oklch(0.967806 0.008589 84.573)",
      chrome: "oklch(0.96001 0.006251 255.475)",
      toolbar: "oklch(0.967806 0.008589 84.573)",
      toolbarForeground: "oklch(0.199944 0.044926 257.333)",
      toolbarBorder: "oklch(0.858278 0.015823 257.203)",
      toolbarControl: "oklch(1 0 0)",
      toolbarControlForeground: "oklch(0.199944 0.044926 257.333)",
      toolbarControlHover: "oklch(0.947049 0.009702 252.813)",
      surface: "oklch(1 0 0)",
      surfaceRaised: "oklch(0.967806 0.008589 84.573)",
      surfaceOverlay: "oklch(1 0 0)",
      text: "oklch(0.199944 0.044926 257.333)",
      textMuted: "oklch(0.507202 0.026881 258.372)",
      border: "oklch(0.858278 0.015823 257.203)",
      input: "oklch(0.807606 0.019627 255.551)",
      focus: "oklch(0.537119 0.16194 31.143)",
      accent: "oklch(0.570253 0.168538 32.063)",
      accentForeground: "oklch(1 0 0)",
      secondary: "oklch(0.947049 0.009702 252.813)",
      secondaryForeground: "oklch(0.199944 0.044926 257.333)",
      muted: "oklch(0.96001 0.006251 255.475)",
      mutedForeground: "oklch(0.507202 0.026881 258.372)",
      placeholder: "oklch(0.507202 0.026881 258.372)",
      secondaryLabel: "oklch(0.507202 0.026881 258.372)",
      iconMuted: "oklch(0.507202 0.026881 258.372)",
      error: "oklch(0.500336 0.182051 29.513)",
      errorForeground: "oklch(0.420049 0.147314 28.135)",
      errorSurface: "oklch(0.956016 0.018724 25.604)",
      warning: "oklch(0.574544 0.138031 56.391)",
      warningForeground: "oklch(0.476186 0.103366 61.907)",
      warningSurface: "oklch(0.967788 0.031645 82.771)",
      update: "oklch(0.550234 0.116996 73.341)",
      updateForeground: "oklch(0.476186 0.103366 61.907)",
      updateSurface: "oklch(0.963915 0.040391 86.731)",
      accentSurface: "oklch(0.930813 0.020375 40.531)",
      accentSurfaceForeground: "oklch(0.199944 0.044926 257.333)",
      messageSurface: "oklch(0.935261 0.016957 56.183)",
      messageForeground: "oklch(0.199944 0.044926 257.333)",
      messageAction: "oklch(0.570253 0.168538 32.063)",
      messageActionForeground: "oklch(1 0 0)",
      messageActionHover: "oklch(0.537119 0.16194 31.143)",
      codeBackground: "oklch(0.96001 0.006251 255.475)",
      codeForeground: "oklch(0.199944 0.044926 257.333)",
      sidebar: "oklch(0.947049 0.009702 252.813)",
      sidebarForeground: "oklch(0.199944 0.044926 257.333)",
      sidebarMutedForeground: "oklch(0.507202 0.026881 258.372)",
      sidebarControlSurface: "oklch(0.922859 0.009766 252.815)",
      sidebarRowHover: "oklch(0.967806 0.008589 84.573)",
      sidebarRowActive: "oklch(0.935261 0.016957 56.183)",
      sidebarRowSelected: "oklch(0.930813 0.020375 40.531)",
      sidebarBorder: "oklch(0.858278 0.015823 257.203)",
      terminalBackground: "oklch(0.967806 0.008589 84.573)",
      terminalForeground: "oklch(0.199944 0.044926 257.333)",
      terminalCursor: "oklch(0.570253 0.168538 32.063)",
      terminalSelection: "oklch(0.930813 0.020375 40.531)",
      terminalScrollbar: "oklch(0.819369 0.020144 252.905)",
      terminalScrollbarHover: "oklch(0.807606 0.019627 255.551)",
    },
  },
