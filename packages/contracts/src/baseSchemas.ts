...
export const MissionRunId = makeEntityId("MissionRunId");
export type MissionRunId = typeof MissionRunId.Type;
export const CoordinationRequestId = makeEntityId("CoordinationRequestId");
export type CoordinationRequestId = typeof CoordinationRequestId.Type;
export const ReplanProposalId = makeEntityId("ReplanProposalId");
export type ReplanProposalId = typeof ReplanProposalId.Type;
export const ArchitectPlanProposalId = makeEntityId("ArchitectPlanProposalId");
export type ArchitectPlanProposalId = typeof ArchitectPlanProposalId.Type;
export const SharedResourceId = makeEntityId("SharedResourceId");
export type SharedResourceId = typeof SharedResourceId.Type;
export const ResourceLeaseId = makeEntityId("ResourceLeaseId");
export type ResourceLeaseId = typeof ResourceLeaseId.Type;
export const OwnershipRequestId = makeEntityId("OwnershipRequestId");
export type OwnershipRequestId = typeof OwnershipRequestId.Type;
...
export const TaskReviewSnapshotId = makeEntityId("TaskReviewSnapshotId");
export type TaskReviewSnapshotId = typeof TaskReviewSnapshotId.Type;
export const TaskHandoffId = makeEntityId("TaskHandoffId");
...
export const TaskResultId = makeEntityId("TaskResultId");
export type TaskResultId = typeof TaskResultId.Type;
export const TaskIntegrationArtifactId = makeEntityId("TaskIntegrationArtifactId");
export type TaskIntegrationArtifactId = typeof TaskIntegrationArtifactId.Type;
export const IntegrationBatchId = makeEntityId("IntegrationBatchId");
export type IntegrationBatchId = typeof IntegrationBatchId.Type;
