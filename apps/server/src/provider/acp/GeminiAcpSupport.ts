...
const GEMINI_AUTH_METHOD_GOOGLE = "oauth-personal";
  ...
  Effect.gen(function* () {
    const acpContext = yield* Layer.build(
      AcpSessionRuntime.layer({
        ...
        authMethodId: GEMINI_AUTH_METHOD_GOOGLE,
      }).pipe(
        Layer.provide(
...
export function resolveGeminiAcpBaseModelId(model: string | null | undefined): string | undefined {
