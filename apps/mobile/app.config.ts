    ...
    widgets: [
      {
        ...
        description: "Shows the current state of active Nebula agents.",
...
const config: ExpoConfig = {
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocalNetworkUsageDescription:
        "Allow Nebula to connect to compatible servers on your local network or tailnet.",
  ...
  plugins: [
    ...
    [
      "expo-camera",
      {
        cameraPermission: "Allow Nebula to access your camera so you can scan pairing QR codes.",
